...
- Vercel 배포 페이지: https://cloud-computing-personal-assignment.vercel.app (개인 소개: `/intro.html`)
- 백엔드 Swagger UI: https://cloud-personal-assignment-backend.onrender.com/docs
